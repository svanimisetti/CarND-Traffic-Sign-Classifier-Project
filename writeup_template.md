...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTU4MDQzOTQ5OjFjMjBlZTU3OWU2OGUyM2VjN2FlMzI4ZDM5YWMzMDQ0YTFkZjQ5NDExOWU4MWE3ZGEyNDhjMzNjZGYwMjZlM2M=--31a5a4012eca0b23303fc1021fc48cae1e8fdf13">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="1929:456E:267008D:3D5AB26:58C18F48" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="1929:456E:267008D:3D5AB26:58C18F48" name="octolytics-dimension-request_id" /><meta content="5341040" name="octolytics-actor-id" /><meta content="svanimisetti" name="octolytics-actor-login" /><meta content="ed4d13e091415defd766bdf5a2035cd1461e8cbdd1d99a7ba645d33d12ced030" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="svanimisetti">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="Y2ZlYmFlYmMzZGE5ZDA4NzUzMmQ2NTkzOTdiYzRiZTczNzk4NmVmYmZiNjcyY2U4NzJmZTZhZjU4ZmFkODlkMXx7InJlbW90ZV9hZGRyZXNzIjoiNDkuMjA3LjU2Ljk5IiwicmVxdWVzdF9pZCI6IjE5Mjk6NDU2RToyNjcwMDhEOjNENUFCMjY6NThDMThGNDgiLCJ0aW1lc3RhbXAiOjE0ODkwODAxNDMsImhvc3QiOiJnaXRodWIuY29tIn0=">


  <meta name="html-safe-nonce" content="d93053e68667e7e465b686017b77ca2066248416">
...
<ul class="header-nav user-nav float-right" id="user-links">
  <li class="header-nav-item">
    ...
    <a href="/notifications" aria-label="You have unread notifications" class="header-nav-link notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator" data-channel="tenant:1:notification-changed:5341040" data-ga-click="Header, go to notifications, icon:unread" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/svanimisetti"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@svanimisetti" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/5341040?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">svanimisetti</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/svanimisetti" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/svanimisetti?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="EMaNC/4ygUBeKCWeLPHOzLFsMn4gAk8t7ZYOHpD+YCoTXPniSns06w0nkl8gyzEnVy5WOlgbpRKyP7VQkQnXLw==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="jLAEnIwVLH4KTS1Q/1dBuisrt99sf57MvLXHBqQWY1mPKnB1OFyZ1VlCmpHzbb5RzWnTmxRmdPPjHHxIpeHUXA==" /></div>
      <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
        Sign out
      </button>
</form>  </div>
...
<div class="pagehead repohead instapaper_ignore readability-menu experiment-repo-nav">
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="MFqTfZxB4/CX8DMXE4WSzKoPoMZE1w4o3/1HNpHtWqkpToymLn6C3sZyVGnUUq0JYeQ2CYj+y0WHwKoNiZ1qlQ==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="71733016" />
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/udacity/CarND-Traffic-Sign-Classifier-Project/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Lhegvlzw33x6tucXZ5l/emJaU2tu7Kqa3etWGau1xfJ05UCWPbu+EfWsK3sW1zqaH/UX00psRiOQ2LPhdQaSaA==" /></div>
      <button
        type="submit"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/udacity/CarND-Traffic-Sign-Classifier-Project/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="XX7CvsDEL1V1VU6wKwrteMd56ECfa6tIsTXnAwj1qqNfHGXTb3HbKJ0eEeOfF1vKEBMdkPwgxPW1HTromLLMKQ==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/udacity/CarND-Traffic-Sign-Classifier-Project/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="bX7PGb1b9xdJ8GY40m+Mb7gJB7M8u23SOHSjYupQ0pr/6e4042fa9EJpHvxiHY4bsY1+x+BI0ffh/756XdYPUw==" /></div>
            <button
                type="submit"
...
<a href="/udacity/CarND-Traffic-Sign-Classifier-Project/blob/050f1edb2c92bce66256aed2075da13923778b9f/writeup_template.md" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      ...
      <a href="/udacity/CarND-Traffic-Sign-Classifier-Project/commits/master/writeup_template.md" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/udacity/CarND-Traffic-Sign-Classifier-Project/edit/master/writeup_template.md" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="8mc0fdDP88YjZEj6Y4ELTLLEHiiIPTnWPHdiRzaOBhf/OPdQ8+9AUIdYafvAs0h3p4+ut1fwyqun0q2FO0Rw9w==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Edit the file in your fork of this project" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/udacity/CarND-Traffic-Sign-Classifier-Project/delete/master/writeup_template.md" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="sCjOq0k2HpG70l1/gdau4fIvvN4IIpAkhen/fTpLg6QC2qlW+ZJH/vs1AxVs3i38yrwqQc1uGqMdsYa+h00A6g==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.08289s from github-fe-bd32a9f.cp1-iad.github.net">GitHub</span>, Inc.</li>
